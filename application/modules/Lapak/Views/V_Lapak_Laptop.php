...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                <p class="lead">Shop Kategori</p>
                <div class="list-group">
                    <a href="<?= base_url()."Lapak/Laptop/" ?>" class="list-group-item">LAPTOP</a>
                    <a href="#" class="list-group-item">MONITOR</a>
                    <a href="#" class="list-group-item">KEYBOARD</a>
                    <a href="#" class="list-group-item">PRINTER</a>
                    <a href="#" class="list-group-item">SPAREPART</a>
                    <a href="#" class="list-group-item">ACCECORIES</a>
                    </br></br>  
                    <div class="col-md-12">
                         <div class="row">
                      <div class="thumbnail">
            ...
            <div class="col-md-9">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="slide-image" src="<?php echo base_url()."assets/img/roll_image/1.jpg"?>" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="<?php echo base_url()."assets/img/roll_image/2.jpg"?>" alt="">
                                </div>
                                <div class="item">
                                    <img class="slide-image" src="<?php echo base_url()."assets/img/roll_image/3.jpg"?>" alt="">
                                </div>
                            </div>
                ...
                <?php foreach($produk->result() as $row): ?>
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            <img src="<?php echo base_url()."assets/img/market/".$row->gambar_produk ?>" alt="">
                                <div class="caption">
                                <h4><a href="#"><?= $row->nama ?></a></h4>
                                <h4 class="pull-right">Rp. <?= $row->harga ?></h4></br>
                                <p><?= $row->kondisi ?></br>
                                <?= $row->keterangan?>
                                <!--<a target="_blank" href="http://www.bootsnipp.com">Bootsnipp - http://bootsnipp.com</a>--></p>
                                <a href="#">detil produk</a>
                            </div>
                            <div class="ratings">
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; Komputerku.2016</p>
                </div>
            </div>
        </footer>
