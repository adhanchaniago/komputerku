        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">ADMIN - .KOMPUTERKU</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  ADMIN - .KOMPUTERKU - Web Developer
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url()."Dashboard" ?>"><i class="fa fa-circle-o"></i> Dashboard user</a></li>

            <li><a href="Admin/Tambah_Admin/"><i class="fa fa-circle-o"></i> Tambah Admin</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
